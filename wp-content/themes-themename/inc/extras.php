 ...
 *
 * @package srbridge theme sparkling
 */
...
function sparkling_footer_info() {
	...
	printf( esc_html__( '©2020 - Present, DraysBling. All Rights Reserved. %1$s We Power the Web %2$s', '' ), '<a href="http://.com/" target="_blank"></a>', '<a href="http://srbridge.com/" target="_blank">SRBridge</a>' );
}
